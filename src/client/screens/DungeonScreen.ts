  ...
  public init(): void {
    ...
    class MainGameScene extends Phaser.Scene {
      ...
      createProceduralTextures() {
        ...
        gWarriorM.fillStyle(0xfbbf24, 1); gWarriorM.fillRect(12, 4, 24, 4);
        gWarriorM.fillStyle(0x10b981, 1); gWarriorM.fillTriangle(6, 6, 12, 2, 12, 10);
        // Legendary Glowing Murim Qi Sword (Steel & Cyan Aura)
        gWarriorM.lineStyle(5, 0x06b6d4, 0.85); gWarriorM.lineBetween(32, 24, 46, 4);
        gWarriorM.lineStyle(3, 0xffffff, 1); gWarriorM.lineBetween(32, 24, 46, 4);
        gWarriorM.fillStyle(0xfbbf24, 1); gWarriorM.fillCircle(32, 24, 3);
        ...
        gWarriorF.lineStyle(5, 0xec4899, 0.85); gWarriorF.lineBetween(32, 24, 46, 4);
        gWarriorF.lineStyle(3, 0xffffff, 1); gWarriorF.lineBetween(32, 24, 46, 4);
