  ...
  public init(): void {
    ...
    class MainGameScene extends Phaser.Scene {
      ...
      createProceduralTextures() {
        ...
        gWarriorM.fillStyle(0x10b981, 1); gWarriorM.fillRect(14, 18, 20, 22);
        gWarriorM.fillStyle(0xffd1b3, 1); gWarriorM.fillCircle(24, 14, 11);
        ...
        gWarriorM.lineStyle(1.5, 0x991b1b, 0.9); gWarriorM.lineBetween(17, 14, 21, 18);
        gWarriorM.fillStyle(0x334155, 1); gWarriorM.fillRect(12, 2, 24, 8);
        gWarriorM.fillStyle(0xfbbf24, 1); gWarriorM.fillTriangle(10, 4, 14, 4, 8, -4); gWarriorM.fillTriangle(34, 4, 38, 4, 40, -4);
        gWarriorM.lineStyle(4, 0xf8fafc, 1); gWarriorM.lineBetween(34, 22, 46, 8);
        gWarriorM.fillStyle(0x047857, 1); gWarriorM.fillCircle(10, 28, 9);
        gWarriorM.generateTexture('chibi_warrior_m', 48, 48);

        const gWarriorF = this.make.graphics({ x: 0, y: 0, add: false });
        gWarriorF.fillStyle(0x10b981, 1); gWarriorF.fillRect(14, 18, 20, 22);
        gWarriorF.fillStyle(0x7c2d12, 1); gWarriorF.fillCircle(24, 16, 14);
        gWarriorF.fillStyle(0xffd1b3, 1); gWarriorF.fillCircle(24, 14, 10);
        gWarriorF.fillStyle(0x047857, 1); gWarriorF.fillCircle(20, 13, 2.5); gWarriorF.fillCircle(28, 13, 2.5);
        gWarriorF.fillStyle(0xffffff, 1); gWarriorF.fillCircle(19, 12, 1); gWarriorF.fillCircle(27, 12, 1);
        gWarriorF.fillStyle(0xf43f5e, 0.8); gWarriorF.fillCircle(19, 16, 2); gWarriorF.fillCircle(29, 16, 2);
        gWarriorF.lineStyle(2, 0x34d399, 1); gWarriorF.strokeCircle(24, 5, 7);
        gWarriorF.lineStyle(4, 0xf8fafc, 1); gWarriorF.lineBetween(34, 22, 46, 8);
      ...
      attackTowardsPointer(targetX: number, targetY: number) {
        ...
        if (jobClass === 'SAMURAI') {
          // SAMURAI IAIJUTSU DASH ATTACK: Instantly dashes through target with long katana slash arc & afterimages!
          const dashDist = dist + 80;
          const pastX = startX + Math.cos(angle) * dashDist;
          const pastY = startY + Math.sin(angle) * dashDist;

          // Render long Katana Slash Beam arc line along trajectory
          ...
          // Spawn 3 Samurai Shadow Afterimages
          for (let i = 1; i <= 3; i++) {
            const ratio = i / 4;
        ...
        if (jobClass === 'ARCHER') {
          proj.setScale(2.5); // Giant, Bold & Highly Noticeable Archer Arrow!
        }
